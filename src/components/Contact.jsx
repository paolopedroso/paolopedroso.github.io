...
const socialLinks = [
    {
      href: 'https://www.github.com/paolopedroso',
    ...
    },
    {
        ...
        icon: <img src="/images/leetcode-svgrepo-com.svg" width='18' height='18' />
    }
  ];
    ...
    return (
        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form 
                    action="https://getform.io/f/bolldkxa" 
                    method="POST"
                ...
                >
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                ...
                                autoComplete="email"
                                required
                                placeholder="paoloapedroso@example.com"
                                className="text-field reveal-up"
                            />
                        </div>
                    </div>
                    ...
                    <button 
                        type="submit"
                        className="reveal-up btn btn-primary [&]:max-w-full w-full justify-center"
                    >
                        Submit
                    </button>
                </form>
